...
//+------------------------------------------------------------------+
// Add hashing
// Add if signal for close order arrived, close these orders type.
// Open a order if signal arrived. Drawdown become too big 34%. It is necessary Optimize
// This aproch in not good. It doesn't earn money fluently.
...
bool ProcessOpenedHedgeOrders()
{
   ...
   return CloseOrders(_symbol, MAGICNUMBER, Slippage, signal);
}