...
extern int    StoplossBuy = 25; // Stop loss by buy position in pips
extern int    StoplossSell = 25; // Stop loss by sell position in pips
...
int OnInit()
{
    ...
    _stoplossBuy = StoplossBuy * _point;
    _stoplossSell = StoplossSell * _point;
