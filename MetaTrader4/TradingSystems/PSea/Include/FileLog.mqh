...
class CFileLog : protected CFile
  {
private:
...
public:
                     CFileLog();
                     CFileLog(string filename="example.log",ENUM_LOG_LEVEL level=3,bool print=false, bool isOptimasation = false);
                    ~CFileLog();
...
protected:
  ...
  int               Open(const string file_name,const int open_flags);
   ...
   //protected uint              Write(const string value);
...
//|             print to console                                     |
//+------------------------------------------------------------------+
CFileLog::CFileLog(string file_name="example.log",ENUM_LOG_LEVEL level=3,bool print=false, bool isOptimasation = false)
{
  _isOptimization = isOptimasation;
